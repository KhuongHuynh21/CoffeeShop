...
function SignUpFormForAdditionalInfo({ address, phone, gender, dateOfBirth, longitude, formName, latitude, submitHandler }: SignUpFormForAdditionalInformationProps) {
